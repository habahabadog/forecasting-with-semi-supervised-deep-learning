...
# 数据集划分
train_size = len(train_files) * 8 // 10
...
test_load = DataLoader(test_dataset, batch_size=1, shuffle=False, num_workers=1, pin_memory=True)
new_load = DataLoader(new_dataset, batch_size=1, shuffle=False, num_workers=1, pin_memory=True)